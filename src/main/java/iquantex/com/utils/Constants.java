...
public final class Constants {
     ...
     * envConfig
     */
    public static final String PRESENT_ENV="present.env";
    public static final String DS_USER_NAME="user.name";
    public static  final String DS_USER_PASSWD="password";
    public static final String DS_IP="ds.ip";
    public static final String DS_PORT="ds.port";
    public static final String DS_TENANT="tenant";
    public static final String DS_DB_TYPE="ds.db.type";
    public static final String DS_DB_IP="ds.db.ip";
    public static final String DS_DB_PORT="ds.db.port";
    public static final String DB_USER="db.user";
    public static final String DB_PASSWD="db.passwd";
    public static final String DB_DATABASE="db.database";
    public static final String projectName="projectName";
    public static final String DS_RECEIVERS="receivers";
    public static final String DS_RECEIVERSCC="receiversCc";
    /**
     * 坐标轴随机数位数
     */
     ...
     * task随机数范围
     */
    public static final int RANDOM_ID = 5;
    /**
     * 失败最大尝试次数
     */
     ...
     * sheet页数量
     */
    public static final int SHEET_NO = 3;
    /**
     * Job名判断
     */
     ...
     * 作业超时时间
     */
    public static final String TIMEOUT = "120";
